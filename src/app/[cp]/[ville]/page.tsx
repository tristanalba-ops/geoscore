          ...
          __html: JSON.stringify([
            {
              ...
              "@type": "City",
              "@id": `https://app.intentanalytics.fr/${params.cp}/${params.ville}#city`,
              name: villeName,
              description: stats.wiki_summary || `Analyse immobilière et territoriale de ${villeName} (${params.cp})`,
              url: `https://app.intentanalytics.fr/${params.cp}/${params.ville}`,
              containedInPlace: {
                "@type": "AdministrativeArea",
                name: `Département ${codeDept}`,
                url: `https://app.intentanalytics.fr/departement/${codeDept}`,
              },
              ...
              additionalProperty: [
                ...
                stats.nb_adresses && { "@type": "PropertyValue", name: "Adresses indexées", value: stats.nb_adresses },
                ...
                stats.bpe_score && { "@type": "PropertyValue", name: "Score équipements", value: stats.bpe_score, maxValue: 100 },
                stats.revenu_median && { "@type": "PropertyValue", name: "Revenu médian", value: stats.revenu_median, unitCode: "EUR" },
              ].filter(Boolean),
            },
            {
              "@context": "https://schema.org",
              "@type": "Dataset",
              name: `Données immobilières — ${villeName} (${params.cp})`,
              description: `Statistiques immobilières, DPE, risques et démographie pour ${villeName}. ${stats.nb_adresses ?? ""} adresses analysées.`,
              url: `https://app.intentanalytics.fr/${params.cp}/${params.ville}`,
              license: "https://www.etalab.gouv.fr/licence-ouverte-open-licence/",
              isAccessibleForFree: true,
              spatialCoverage: { "@id": `https://app.intentanalytics.fr/${params.cp}/${params.ville}#city` },
              creator: { "@id": "https://app.intentanalytics.fr/#organization" },
            },
            ...(voies.length > 0 ? [{
              "@context": "https://schema.org",
              "@type": "ItemList",
              name: `Rues de ${villeName}`,
              numberOfItems: voies.length,
              itemListElement: voies.slice(0, 20).map((v: any, i: number) => ({
                "@type": "ListItem",
                position: i + 1,
                name: v.nom_voie,
                url: `https://app.intentanalytics.fr/${params.cp}/${params.ville}/${slugify(v.nom_voie)}`,
              })),
            }] : []),
            {
              "@context": "https://schema.org",
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 3, name: `${villeName} (${params.cp})`, item: `https://app.intentanalytics.fr/${params.cp}/${params.ville}` },
              ],
            },
          ]),
        }}
