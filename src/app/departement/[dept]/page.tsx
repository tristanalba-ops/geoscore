          ...
          __html: JSON.stringify([
            {
              ...
              "@id": `https://app.intentanalytics.fr/departement/${params.dept}#area`,
              name: `Département ${params.dept}${stats.nom_departement ? ` — ${stats.nom_departement}` : ""}`,
              description: `Analyse immobilière du département ${params.dept} : ${formatNum(stats.nb_communes)} communes, ${formatNum(stats.nb_adresses)} adresses, prix médian ${formatNum(stats.prix_m2_median)} €/m².`,
              url: `https://app.intentanalytics.fr/departement/${params.dept}`,
              containedInPlace: { "@type": "Country", name: "France", sameAs: "https://www.wikidata.org/wiki/Q142" },
              additionalProperty: [
                { "@type": "PropertyValue", name: "Communes analysées", value: stats.nb_communes },
                { "@type": "PropertyValue", name: "Adresses indexées", value: stats.nb_adresses },
                stats.prix_m2_median && { "@type": "PropertyValue", name: "Prix médian au m²", value: stats.prix_m2_median, unitCode: "EUR" },
                stats.population && { "@type": "PropertyValue", name: "Population", value: stats.population },
                stats.dpe_dominant && { "@type": "PropertyValue", name: "Classe DPE dominante", value: stats.dpe_dominant },
              ].filter(Boolean),
            },
            {
              "@context": "https://schema.org",
              "@type": "Dataset",
              name: `Données immobilières — Département ${params.dept}`,
              description: `Statistiques immobilières pour ${formatNum(stats.nb_adresses)} adresses dans ${formatNum(stats.nb_communes)} communes du département ${params.dept}.`,
              url: `https://app.intentanalytics.fr/departement/${params.dept}`,
              license: "https://www.etalab.gouv.fr/licence-ouverte-open-licence/",
              isAccessibleForFree: true,
              spatialCoverage: { "@id": `https://app.intentanalytics.fr/departement/${params.dept}#area` },
              creator: { "@id": "https://app.intentanalytics.fr/#organization" },
              variableMeasured: [
                { "@type": "PropertyValue", name: "Prix au m²" },
                { "@type": "PropertyValue", name: "Classe DPE" },
                { "@type": "PropertyValue", name: "Population" },
              ],
            },
            {
              "@context": "https://schema.org",
              "@type": "CollectionPage",
              name: `Communes du département ${params.dept}`,
              url: `https://app.intentanalytics.fr/departement/${params.dept}`,
              ...
              mainEntity: {
                ...
                itemListElement: communes.slice(0, 20).map((c: any, i: number) => ({
                  "@type": "ListItem",
                  position: i + 1,
                  name: `${c.nom_commune} (${c.code_postal})`,
                  url: `https://app.intentanalytics.fr/${c.code_postal}/${slugify(c.nom_commune)}`,
                })),
              },
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 2, name: `Département ${params.dept}`, item: `https://app.intentanalytics.fr/departement/${params.dept}` },
              ],
            },
          ]),
        }}
